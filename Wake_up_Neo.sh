...
# Установка размера шрифта терминала (может не работать во всех терминалах)
echo -e "\e]710;xft:Consolas:size=16\e\\"

# Установка размера окна терминала (может не работать во всех терминалах)
printf '\e[8;25;80t'
